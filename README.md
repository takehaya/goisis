...
- **HMAC authentication** of hellos and LSPs/SNPs — HMAC-MD5 (RFC 5304),
  wire-compatible with FRR's `isis password`/`area-password`/`domain-password md5`,
  and HMAC-SHA-1/256/384/512 (RFC 5310)
